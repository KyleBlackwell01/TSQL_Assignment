...
BEGIN
    RETURN CONCAT('CustID: ', (@PCUSTID ), ' Name: ', (Select CUSTNAME FROM CUSTOMER Where @PCUSTID = CUSTID), ' Status: ', (Select STATUS FROM CUSTOMER Where @PCUSTID = CUSTID), ' SalesYTD: ', (Select SALES_YTD FROM CUSTOMER Where @PCUSTID = CUSTID));
END
GO
